...
QwsConnection::QwsConnection(QObject *parent) : QObject(parent)
{
 ...
 */
int QwsConnection::getUniqueUserId() {
//    static int tmpUserId=0;
//    return ++tmpUserId;
}

int QwsConnection::getUniqueChatId() {
//    static int tmpChatId=10;
//    return ++tmpChatId;
}


void QwsConnection::registerClient(WiredSocket *socket)
{
    if(!socket) return;
 ...
 */
void QwsConnection::sendUserlist(const int id, const int chatId) {
 ...
 */
void QwsConnection::checkLogin(const int id, const QString login, const QString password) {
//    WiredSocket *socket = pClients[id];
//
//    qDebug() << "Checking login:" << login << password;
//    QSqlQuery query;
//    query.prepare("SELECT id FROM qws_accounts WHERE acc_name=:_name AND acc_secret=:_secret");
//    query.bindValue(":_name", login);
//    query.bindValue(":_secret", password);
//    if(query.exec()) {
//        query.first();
//        if(query.isValid()) {
//            socket->pSessionUser.userLogin = login;
 ...
 */
void QwsConnection::broadcastChat(const int id, const int chatId, const QString text, const bool emote) {
 ...
 */
void QwsConnection::removeClient(const int id) {
//    qDebug() << "[core] broadcasting user-left from"<<id;
//
//    // Check for private chats
//    QHashIterator<int,QwsRoom > j(pPrivateChats);
 ...
 */
void QwsConnection::kickUser(const int id, const int userId, const QString reason, const bool banned) {
...
void QwsConnection::broadcastUserImageChanged(const ClassWiredUser user) {
 ...
 */
void QwsConnection::broadcastUserStatusChanged(const ClassWiredUser user) {
 ...
 */
void QwsConnection::deliverPrivateMessage(const int id, const int targetId, const QString text) {
 ...
 * @param id The ID of the user.
 */
void QwsConnection::sendServerBanner(const int id) {
//    qDebug() << "[core] sending server banner to"<<id;
//    pClients[id]->sendBanner(pBannerData);
}

void QwsConnection::broadcastBroadcast(const int id, const QString text) {
...
void QwsConnection::createPrivateChat(const int id) {
 ...
 */
void QwsConnection::inviteUserToChat(const int id, const int userId, const int chatId) {
...
//    QwsRoom &chat = pPrivateChats[chatId];
 ...
 * @param chatId The ID of the chat.
 */
void QwsConnection::joinPrivateChat(const int id, const int chatId) {
 ...
 * @param chatId The ID of the chat.
 */
void QwsConnection::declinePrivateChat(const int id, const int chatId) {
 ...
 * @param chatId The ID of the chat.
 */
void QwsConnection::removeFromPrivateChat(const int userId, const int chatId) {
//    if(!pPrivateChats.contains(chatId)) return;
//    QwsRoom &tmpUsers = pPrivateChats[chatId];
//
 ...
 */
void QwsConnection::setClientInfo(const int id, const QString info) {
 ...
 */
void QwsConnection::broadcastChatTopic(const ClassWiredUser user, const int chatId, const QString topic) {
 ...
 */
void QwsConnection::postNews(const int id, const QString news) {
//    qDebug() << "[core] broadcasting new news-post from user"<<id;
//    QString tmpNick = QString("%1 [%2]").arg(pClients[id]->sessionUser().userNickname).arg(pClients[id]->sessionUser().userLogin);
//    QSqlQuery query;
 ...
 */
void QwsConnection::sendAccountsList(const int id) {
//    WiredSocket *socket = pClients[id];
 ...
 * @param id The ID of the user who requsted the list of accounts.
 */
void QwsConnection::sendGroupsList(const int id) {
//    WiredSocket *socket = pClients[id];
 ...
 */
void QwsConnection::sendUserSpec(const int id, const QString name) {
//    QSqlQuery query;
 ...
 */
void QwsConnection::sendGroupSpec(const int id, const QString name) {
//    QSqlQuery query;
 ...
 */
void QwsConnection::createUser(const int id, const ClassWiredUser user) {
//    QSqlQuery query;
//    query.prepare("SELECT * FROM qw_accounts WHERE login=:login;");
//    query.bindValue(":login", user.userLogin);
//    query.exec(); query.first();
//    if(query.isValid()) {
 ...
 * @param user The object containing the account data.
 */
void QwsConnection::createGroup(const int id, const ClassWiredUser group) {
//    QSqlQuery query;
 ...
 * @param user The object containing the account data.
 */
void QwsConnection::editUser(const int id, const ClassWiredUser user) {
//    QSqlQuery query;
//    query.prepare("SELECT * FROM qw_accounts WHERE login=:login;");
//    query.bindValue(":login", user.userLogin);
//    query.exec(); query.first();
...
//            if(client && client->sessionUser().userLogin==user.userLogin) {
 ...
 * @param user The object containing the account data.
 */
void QwsConnection::editGroup(const int id, const ClassWiredUser group) {
//    QSqlQuery query;
//    query.prepare("SELECT * FROM qw_groups WHERE groupname=:name;");
//    query.bindValue(":name", group.pGroupName);
//    query.exec(); query.first();
 ...
 */
void QwsConnection::deleteUser(const int id, const QString name)
{
//    QSqlQuery query;
 ...
 */
void QwsConnection::deleteGroup(const int id, const QString name)
{
//    QSqlQuery query;
 ...
 */
void QwsConnection::sendFileStat(const int id, const QString path)
{
 ...
 */
void QwsConnection::sendFileList(const int id, const QString path) {
//    WiredSocket *socket = pClients[id];
...
//        socket->sendError(Qws::ErrorFileOrDirectoryNotFound);
//        return;
//    }
}
